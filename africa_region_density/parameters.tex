...
{\it Value:} africa_region_density
...
{\it Value:} ./input_files/lithosphere_shells.txt
...
{\it Value:} visualization, velocity statistics, surface velocities, temperature statistics
