...
{\it Value:} p=-0.01, L=4.6e6, D=3e6, pi=3.1415926536, k=1, T_top=273, T_bottom=3600
...
{\it Value:} T_top + (T_bottom-T_top)*(1-(y/D)-p*cos(k*pi*x/L)*sin(pi*y/D))
...
{\it Value:} velocity statistics, temperature statistics, heat flux statistics, visualization, basic statistics
