...
{\it Value:} output_crustal_model_3D
...
{\it Value:} if (x<56e3 && y<=48e3 | x<72e3 && y>48e3, -1*cm/year, 1*cm/year) ; 0 ; 0
...
{\it Value:} crustal_thickness.txt
...
{\it Value:} left: function, right:function, bottom:function
...
{\it Value:} visualization, velocity statistics, topography, pressure statistics, velocity statistics
...
{\it Value:} density, viscosity, strain rate, error indicator, partition
