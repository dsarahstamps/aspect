...
{\it Value:} if (x<40e3 , 1*cm/year, -1*cm/year) ; 0
...
{\it Value:} visualization, velocity statistics, basic statistics
...
{\it Value:} density, viscosity, strain rate, error indicator, friction heating, partition
