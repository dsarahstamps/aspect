...
{\it Value:} ./input_files/topography_africa_0.5.txt
...
{\it Value:} ./input_files/lithosphere_africa_0.5.txt
...
{\it Value:} ./input_files/crust_africa_0.5.txt
...
{\it Value:} visualization, velocity statistics, surface velocities, temperature statistics, dynamic topography
...
{\it Value:} viscosity, density, melt fraction, strain rate, dynamic topography
